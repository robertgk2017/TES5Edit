...
const
  ...
  FIHS : TwbSignature = 'FIHS'; { New To Fallout 76 }
  FIJS : TwbSignature = 'FIJS'; { New To Fallout 76 }
  FILA : TwbSignature = 'FILA'; { New To Fallout 76 }
  FILD : TwbSignature = 'FILD'; { New To Fallout 76 }
  FILJ : TwbSignature = 'FILJ'; { New To Fallout 76 }
