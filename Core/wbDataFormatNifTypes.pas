...
begin
  Result := dfEnum(aName, dtU32, [
    Int64(0),          'SKY_HAV_MAT_NONE',
    Int64(131151687),  'SKY_HAV_MAT_STONE_BROKEN',
    Int64(165778930),  'SKY_HAV_MAT_WEAPON_BLADE_1HAND_BLOCK',
    Int64(220124585),  'SKY_HAV_MAT_MEAT',
    Int64(322207473),  'SKY_HAV_MAT_CARRIAGE_WHEEL',
    Int64(346811165),  'SKY_HAV_MAT_METAL_LIGHT',
    Int64(365420259),  'SKY_HAV_MAT_WOOD_LIGHT',
    Int64(398949039),  'SKY_HAV_MAT_SNOW',
    Int64(428587608),  'SKY_HAV_MAT_GRAVEL',
    Int64(438912228),  'SKY_HAV_MAT_METAL_CHAIN',
    Int64(493553910),  'SKY_HAV_MAT_BOTTLE',
    Int64(500811281),  'SKY_HAV_MAT_WOOD',
    Int64(534864873),  'SKY_HAV_MAT_ASH',
    Int64(551270354),  'SKY_HAV_MAT_STAIRS_METAL',
    Int64(591247106),  'SKY_HAV_MAT_SKIN',
    Int64(593401068),  'SKY_HAV_MAT_WEAPON_BLUNT_1HAND_BLOCK',
    Int64(668408902),  'SKY_HAV_MAT_INSECT',
    Int64(732141076),  'SKY_HAV_MAT_BARREL',
    Int64(781661019),  'SKY_HAV_MAT_CERAMIC',
    Int64(790784366),  'SKY_HAV_MAT_BASKET',
    Int64(873356572),  'SKY_HAV_MAT_ICE',
    Int64(880200008),  'SKY_HAV_MAT_STAIRS_GLASS',
    Int64(899511101),  'SKY_HAV_MAT_STAIRS_STONE',
    Int64(1024582599), 'SKY_HAV_MAT_WATER',
    Int64(1060167844), 'SKY_HAV_MAT_WEAPON_BLADE_1HAND',
    Int64(1264672850), 'SKY_HAV_MAT_BOOK',
    Int64(1286705471), 'SKY_HAV_MAT_CARPET',
    Int64(1288358971), 'SKY_HAV_MAT_METAL_SOLID',
    Int64(1305674443), 'SKY_HAV_MAT_WEAPON_AXE',
    Int64(1312943906), 'SKY_HAV_MAT_WEAPON_BLADE_2HAND_BLOCK',
    Int64(1322093133), 'SKY_HAV_MAT_ORGANIC_LARGE',
    Int64(1461712277), 'SKY_HAV_MAT_STAIRS_WOOD',
    Int64(1486385281), 'SKY_HAV_MAT_MUD',
    Int64(1550912982), 'SKY_HAV_MAT_BOULDER_SMALL',
    Int64(1560365355), 'SKY_HAV_MAT_STAIRS_SNOW',
    Int64(1570821952), 'SKY_HAV_MAT_STONE_HEAVY',
    Int64(1607128641), 'SKY_HAV_MAT_WEAPON_BOWS_AND_STAVES',
    Int64(1730220269), 'SKY_HAV_MAT_ALDUIN',
    Int64(1763418903), 'SKY_HAV_MAT_WEAPON_BOWS_AND_STAVES_BLOCK',
    Int64(1803571212), 'SKY_HAV_MAT_WOOD_AS_STAIRS',
    Int64(1848600814), 'SKY_HAV_MAT_GRASS',
    Int64(1885326971), 'SKY_HAV_MAT_BOULDER_LARGE',
    Int64(1886078335), 'SKY_HAV_MAT_STONE_AS_STAIRS',
    Int64(2022742644), 'SKY_HAV_MAT_WEAPON_BLADE_2HAND',
    Int64(2025794648), 'SKY_HAV_MAT_BOTTLE_SMALL',
    Int64(2058949504), 'SKY_HAV_MAT_BONE_ACTOR',
    Int64(2168343821), 'SKY_HAV_MAT_SAND',
    Int64(2229413539), 'SKY_HAV_MAT_METAL_HEAVY',
    Int64(2431524493), 'SKY_HAV_MAT_ICE_FORM',
    Int64(2518321175), 'SKY_HAV_MAT_DRAGON',
    Int64(2617944780), 'SKY_HAV_MAT_WEAPON_BLADE_1HAND_SMALL',
    Int64(2632367422), 'SKY_HAV_MAT_SKIN_SMALL',
    Int64(2742858142), 'SKY_HAV_MAT_POTS_AND_PANS',
    Int64(2821299363), 'SKY_HAV_MAT_SKIN_SKELETON',
    Int64(2872791301), 'SKY_HAV_MAT_WEAPON_BLUNT_1HAND',
    Int64(2892392795), 'SKY_HAV_MAT_STAIRS_STONE_BROKEN',
    Int64(2965929619), 'SKY_HAV_MAT_SKIN_LARGE',
    Int64(2974920155), 'SKY_HAV_MAT_ORGANIC',
    Int64(3049421844), 'SKY_HAV_MAT_BONE',
    Int64(3070783559), 'SKY_HAV_MAT_WOOD_HEAVY',
    Int64(3074114406), 'SKY_HAV_MAT_CHAIN',
    Int64(3106094762), 'SKY_HAV_MAT_DIRT',
    Int64(3312543676), 'SKY_HAV_MAT_GHOST',
    Int64(3387452107), 'SKY_HAV_MAT_SKIN_METAL_LARGE',
    Int64(3400476823), 'SKY_HAV_MAT_WEAPON_AXE_BLOCK',
    Int64(3424720541), 'SKY_HAV_MAT_ARMOR_LIGHT',
    Int64(3448167928), 'SKY_HAV_MAT_SHIELD_LIGHT',
    Int64(3589100606), 'SKY_HAV_MAT_COIN',
    Int64(3662306947), 'SKY_HAV_MAT_WEAPON_BLUNT_2HAND_BLOCK',
    Int64(3702389584), 'SKY_HAV_MAT_SHIELD_HEAVY',
    Int64(3708432437), 'SKY_HAV_MAT_ARMOR_HEAVY',
    Int64(3725505938), 'SKY_HAV_MAT_ARROW',
    Int64(3739830338), 'SKY_HAV_MAT_GLASS',
    Int64(3741512247), 'SKY_HAV_MAT_STONE',
    Int64(3764646153), 'SKY_HAV_MAT_WATER_PUDDLE',
    Int64(3839073443), 'SKY_HAV_MAT_CLOTH',
    Int64(3855001958), 'SKY_HAV_MAT_SKIN_METAL_SMALL',
    Int64(3895166727), 'SKY_HAV_MAT_WARD',
    Int64(3934839107), 'SKY_HAV_MAT_WEB',
    Int64(3969592277), 'SKY_HAV_MAT_MATERIAL_BLUNT_2HAND',
    Int64(4283869410), 'SKY_HAV_MAT_BOULDER_MEDIUM'
  ], aDefaultValue, aEvents);
end;
...
begin
  Result := dfEnum(aName, dtU8, [
    ...
    47, 'SKYL_DEADACTORZONE',
    48, 'SKYL_TRIGGER_FALLINGTRAP',
    49, 'SKYL_NAVCUT',
    50, 'SKYL_CRITTER',
    51, 'SKYL_SPELLTRIGGER',
    52, 'SKYL_LIVING_AND_DEAD_ACTORS',
    53, 'SKYL_DETECTION',
    54, 'SKYL_TRAP_TRIGGER'
  ], aDefaultValue, aEvents);
end;
